...
export const homeVerticalDetails: Record<string, HomeVerticalDetail> = {
  hvac: {
    ...
    intro:
      'HVAC is urgency-driven and seasonal. Brew City Automation pairs Google Business Profile optimization with AI workflows for reviews, seasonal offers, and service-area pages—so you show up when homeowners search “AC repair near me” or “furnace tune-up” across SE Wisconsin.',
    painPoints: [
