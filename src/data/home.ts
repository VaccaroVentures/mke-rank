...
export const homeFaq = [
  ...
  },
  {
    ...
    answer:
      'Owner-led and office-manager-led businesses that feel buried in manual tasks—especially local and home-services companies in Milwaukee, Waukesha, Racine, Kenosha, Ozaukee, Washington, and Walworth Counties—are a strong fit. We work best when decision-makers want governance, documentation, and measurable outcomes.',
  },
  {
    question: 'How is this different from a generic marketing agency?',
    answer:
      'We lead with automation consulting and systems thinking: integrations, AI guardrails, and operational throughput. Local SEO and Google Business Profile work are connected services when growing nearby demand is part of the plan.',
  },
  {
    question: 'Do you use human review for AI outputs?',
    answer:
      'Yes. AI accelerates drafts and routing, but client-approved humans review customer-facing content, safety-adjacent language, and anything that affects brand trust.',
  },
  {
