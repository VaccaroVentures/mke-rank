...
export const aiServiceDetails: Record<string, AIServiceDetail> = {
  'ai-automation-consulting': {
    ...
    seoTitle: 'AI Automation Consulting for Small Business | Badger Automation Group',
    seoDescription:
  ...
  'workflow-business-automation': {
    ...
    seoTitle: 'Small Business Workflow Automation & CRM Integration | Badger Automation Group',
    seoDescription:
  ...
  'local-seo-services': {
    ...
    seoTitle: 'Local SEO Services for Small Business | Milwaukee Area | Badger Automation Group',
    seoDescription:
  ...
  'google-business-profile-ai': {
    ...
    seoTitle: 'Google Business Profile Optimization & AI Posts | Badger Automation Group',
    seoDescription:
  ...
  'ai-review-management': {
    ...
    seoTitle: 'AI Review Management & Online Reputation | Small Business | Badger Automation Group',
    seoDescription:
  ...
  'ai-local-content': {
    ...
    seoTitle: 'AI Local Content Writing & SEO Pages | Badger Automation Group',
    seoDescription:
  ...
  'ai-lead-capture-chatbot': {
    ...
    seoTitle: 'AI Chatbot for Lead Capture | Small Business Website | Badger Automation Group',
    seoDescription:
  ...
  'ai-call-handling': {
    ...
    seoTitle: 'AI Voice Agent & Call Answering Service | Small Business | Badger Automation Group',
    seoDescription:
